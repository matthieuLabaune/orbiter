<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto">
        <form action="{{ route('projects.adrs.store', $project) }}" method="POST"
            ...
            <div>
                <label for="title" class="block text-sm font-medium text-gray-600 dark:text-slate-300 mb-1">Titre de la décision</label>
            ...
            <div>
                <label for="context" class="block text-sm font-medium text-gray-600 dark:text-slate-300 mb-1">Contexte</label>
            ...
            <div>
                <label for="decision" class="block text-sm font-medium text-gray-600 dark:text-slate-300 mb-1">Décision</label>
            ...
            <div>
                <label for="consequences" class="block text-sm font-medium text-gray-600 dark:text-slate-300 mb-1">Conséquences</label>
