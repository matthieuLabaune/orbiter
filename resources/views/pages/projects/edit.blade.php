<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-semibold" style="color: var(--o-text);">Modifier {{ $project->name }}</h2>
        </div>
    </x-slot>
    ...
    <div class="max-w-2xl mx-auto">
        <form action="{{ route('projects.update', $project) }}" method="POST"
            ...
            <div class="flex items-center justify-end gap-3">
                <a href="{{ route('projects.show', $project) }}" class="px-4 py-2 text-sm hover:opacity-80 transition-colors" style="color: var(--o-text-2);">
                    Annuler
                </a>
                <button type="submit"
        ...
        <div class="mt-8 bg-red-500/5 border border-red-500/20 rounded-xl p-6">
            ...
            <p class="text-sm mb-4" style="color: var(--o-text-4);">Supprimer ce projet et toutes ses données de manière irréversible.</p>
