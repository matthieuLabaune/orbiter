    ...
    <div class="max-w-7xl mx-auto">
        ...
        @if($projects->isEmpty())
            <div class="text-center py-16">
                <x-lucide-rocket class="w-12 h-12 text-slate-600 mx-auto mb-4" />
                <h3 class="text-lg font-medium text-slate-300 mb-2">Aucun projet</h3>
                <p class="text-slate-500 mb-6">Créez votre premier projet pour commencer.</p>
                <a href="{{ route('projects.create') }}"
                   class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white text-sm font-medium rounded-lg transition-colors">
                    <x-lucide-plus class="w-4 h-4" />
                    Créer un projet
