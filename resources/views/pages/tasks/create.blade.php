<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-semibold" style="color: var(--orbiter-text);">Nouvelle tâche</h2>
        </div>
    </x-slot>
    ...
    <div class="max-w-2xl mx-auto">
        <form action="{{ route('projects.tasks.store', $project) }}" method="POST"
            ...
            <div class="flex items-center justify-end gap-3">
                <a href="{{ route('projects.tasks.index', $project) }}" class="px-4 py-2 text-sm transition-colors" style="color: var(--orbiter-text-muted);">Annuler</a>
