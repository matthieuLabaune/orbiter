        ...
        <form action="{{ route('projects.tasks.update', [$project, $task]) }}" method="POST"
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full bg-slate-800 border border-slate-600 rounded-lg px-3 py-2 text-white focus:border-blue-500">{{ old('description', $task->description) }}</textarea>
            </div>
            ...
            <div class="flex items-center justify-end gap-3">
                <a href="{{ route('projects.tasks.show', [$project, $task]) }}" class="px-4 py-2 text-sm text-slate-400 hover:text-white transition-colors">Annuler</a>
