            ...
            <div>
                ...
                <div class="max-h-48 overflow-y-auto space-y-2 border border-slate-700/50 rounded-lg p-3">
                    ...
                    @if($requirements->isEmpty())
                        <p class="text-xs text-slate-500">Aucune exigence dans ce projet.</p>
                    @endif
                </div>
            </div>

            <div class="flex items-center justify-end gap-3">
                <a href="{{ route('projects.tests.index', $project) }}" class="px-4 py-2 text-sm text-slate-400 hover:text-white transition-colors">Annuler</a>
