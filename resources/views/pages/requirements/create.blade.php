        ...
        <form action="{{ route('projects.requirements.store', $project) }}" method="POST"
            ...
            <div class="border border-gray-200 dark:border-slate-700/50 rounded-lg p-4">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        <label for="risk_impact" class="block text-xs text-gray-500 dark:text-slate-400 mb-1">Impact (1-5)</label>
                    ...
                    <div>
                        <label for="risk_probability" class="block text-xs text-gray-500 dark:text-slate-400 mb-1">Probabilité (1-5)</label>
                    ...
                    <div>
                        <label for="risk_detectability" class="block text-xs text-gray-500 dark:text-slate-400 mb-1">Détectabilité (1-5)</label>
                ...
                <p class="mt-2 text-xs text-gray-400 dark:text-slate-500">Score = Impact × Probabilité × (6 - Détectabilité)</p>
            </div>
