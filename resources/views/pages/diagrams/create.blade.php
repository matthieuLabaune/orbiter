<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-semibold" style="color: var(--o-text);">Nouveau diagramme</h2>
        </div>
    </x-slot>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('projects.diagrams.store', $project) }}" method="POST"
            ...
            <div>
                <label for="mermaid_source" class="block text-sm font-medium mb-1" style="color: var(--o-text-2);">Source Mermaid</label>
                ...
                <p class="mt-1 text-xs" style="color: var(--o-text-4);">
                    <a href="https://mermaid.js.org/intro/" target="_blank" rel="noopener" style="color: var(--o-accent);">Documentation Mermaid.js</a>
                </p>
            </div>

            <div class="flex items-center justify-end gap-3">
                <a href="{{ route('projects.diagrams.index', $project) }}" class="px-4 py-2 text-sm transition-colors" style="color: var(--o-text-4);">Annuler</a>
